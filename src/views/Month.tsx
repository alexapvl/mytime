...
export function MonthView({
  ...
  return (
    <Box flexDirection="column">
      ...
      <ShortcutBar shortcuts={MONTH_SHORTCUTS} context={{ canEdit: false, canReschedule: false, canDelete: false, hasTime: false, hasMeeting: false, hasLink: false, canRespond: false }} />
